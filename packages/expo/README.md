...
# Using bun
bun add faire-auth @faire-auth/expo
```
...
Ensure you have a Faire Auth backend set up. You can follow the main [Installation Guide](https://www.faire-auth.com/docs/installation).
...
- **Main Faire Auth Installation:** [https://www.faire-auth.com/docs/installation](https://www.faire-auth.com/docs/installation)
- **Expo Integration Guide:** [https://www.faire-auth.com/docs/integrations/expo](https://www.faire-auth.com/docs/integrations/expo)
