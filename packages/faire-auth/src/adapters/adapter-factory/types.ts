...
import type { FaireAuthDBSchema, DBFieldAttribute } from "@faire-auth/core/db";
import type {
...
/**
 * @deprecated Use `DBAdapterFactoryConfig` from `@faire-auth/core/db/adapter` instead.
 */
export interface AdapterFactoryConfig
	extends Omit<DBAdapterFactoryConfig<FaireAuthOptions>, "transaction"> {
	/**
	...
	transaction?:
		| false
		| (<R>(
				callback: (trx: TransactionAdapter) => R | Promise<R>,
		  ) => Promise<R>);
}
...
/**
 * @deprecated Use `CustomAdapter` from `@faire-auth/core/db/adapter` instead.
 */
...
/**
 * @deprecated Use `CleanedWhere` from `@faire-auth/core/db/adapter` instead.
 */
