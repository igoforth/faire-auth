...
import type { OrganizationSchema } from "./schema/fields";
...
const createHasPermission = <O extends OrganizationOptions>(options: O) => {
	...
	return createEndpoint(
		createRoute({
			...
			middleware: [orgSessionMiddleware],
			request: req()
				.bdy(
					z.object({ organizationId: z.string().optional() }).and(
						z.union([
							z.object({
							...
							z.object({
								...
								permissions: z.record(z.string(), z.array(z.string())).openapi({
									description: "The permission to check",
								}),
							}),
						]),
					) as unknown as z.ZodType<
						PermissionExclusive & { organizationId?: string }
					>,
				)
				.bld(),
			responses: res(z.object({ success: z.literal(true), data: z.boolean() }))
				.err(400, "No permissions were provided")
				.err(401, "User not member of organization")
				.bld(),
		}),
		(_authOptions) => async (ctx) => {
			const { organizationId, permission, permissions } = ctx.req.valid("json");
			const activeOrganizationId =
				organizationId ?? ctx.get("session").session.activeOrganizationId;
			...
			const member = await adapter.findMemberByOrgId({
				userId: ctx.get("session").user.id,
			...
			const result = await hasPermission(
				{
					role: member.role,
					options: options || {},
					permissions: (permissions ?? permission) as any,
					organizationId: activeOrganizationId,
				},
				ctx,
			);
			return ctx.render({ success: True, data: result }, 200);
		},
	);
};
...
>(
	...
	id: "organization";
	routes: OrganizationEndpoints<O> & TeamEndpoints<O>;
	schema: OrganizationSchema<O>;
	$Infer: {
		Organization: InferOrganization<O>;
		Invitation: InferInvitation<O>;
...
>(
	...
	id: "organization";
	routes: OrganizationEndpoints<O> & DynamicAccessControlEndpoints<O>;
	schema: OrganizationSchema<O>;
	$Infer: {
		Organization: InferOrganization<O>;
		Invitation: InferInvitation<O>;
...
export function organization<O extends OrganizationOptions>(
	...
	let endpoints = {
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-create)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-update)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-delete)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-set-active)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-get-full-organization)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-list)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-invite-member)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-cancel-invitation)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-accept-invitation)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-get-invitation)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-reject-invitation)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-list-invitations)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-get-active-member)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-check-slug)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-add-member)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-remove-member)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-update-member-role)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-leave)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-list-members)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-get-active-member-role)
		 */
		getActiveMemberRole: getActiveMemberRole(options as O),
	};
	const teamSupport = options?.teams?.enabled === true;
	const teamEndpoints = {
		/**
		 * ### Endpoint
		 *
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-create-team)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-list-teams)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-remove-team)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-method-organization-update-team)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-set-active-team)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-add-team-member)
		 */
		 ...
		 *
		 * @see [Read our docs to learn more.](https://faire-auth.com/docs/plugins/organization#api-remove-team-member)
		 */
		removeTeamMember: removeTeamMember(options as O),
	};
	if (teamSupport) endpoints = { ...endpoints, ...teamEndpoints };

	const dynamicAccessControlSupport =
		options?.dynamicAccessControl?.enabled === true;
	...
	if (dynamicAccessControlSupport)
		endpoints = {
			...endpoints,
			...dynamicAccessControlEndpoints,
		};

	// const roles = { ...defaultRoles, ...options?.roles }
	...
	return {
		id: "organization",
		routes: {
			...(endpoints as OrganizationEndpoints<O>),
			hasPermission: createHasPermission(options as O),
		},
		schema: {
			...(schema as FaireAuthPluginDBSchema),
			session: {
				fields: {
					...
					...(teamSupport
						...
						: {}),
				} as unknown as O["teams"] extends { enabled: true }
					? {
