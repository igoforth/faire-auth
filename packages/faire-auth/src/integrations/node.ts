...
async function setResponse(res: ServerResponse, response: Response) {
...
export function toNode(handler: Auth["handler"]) {
...
) => ("handler" in auth ? toNode(auth.handler) : toNode(auth));
