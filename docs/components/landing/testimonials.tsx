...
const testimonials = [
	{
		...
		description:
			"This has been the best auth experience by a mileee, auto generated my drizzle schemas for users, sessions etc, full type safe and dead simple api, well done @faire_auth 👏👏",
	...
	},
	{
		...
		description:
			"I didn't know  @faire_auth was THAT good. I'm implementing it in TanStack Start and I can't believe how good the DX is. This is my favorite stack now (along with  @DrizzleORM and @shadcn ui).",
	...
	},
	{
		...
		description:
			"I rarely stumble upon a framework/library that makes me rethink things. @faire_auth is a rare exception. it literally delayed @zerotoshipped for a week...",
	...
	},
	{
		...
		description:
			"When @faire_auth meets @nuxt_hub to build full-stack Nuxt apps on Cloudflare (using D1 & KV).",
...

	{
		...
		description:
			"between faire-auth and openauth one of those options should cover how you want to do things for 95% of cases. the problem of defaulting to SaaS for auth in js is finally fixed...",
...
2. Go back to 1`,
	...
	},
	{
		...
		description: `using faire-auth for the first time
...
holy sh** is it good, works so nice with typescript + drizzle`,
	...
	},
	{
		...
		description: `We've been using @faire_auth in prod @IndexBI and absolutely love it. Super comprehensive from day one.👏`,
	...
	},
	{
		...
		profession: "Content Creator",
		description: `i swear @polar_sh and @faire_auth developer experience should be mandatory teaching for all CS students`,
	...
	},
	{
		...
		description:
			"i have been using faire-auth for exon todo and it is like so fast, I set it up once and it just works",
	...
	},
	{
		...
		description:
			"@faire_auth exceeded all expectations, and it's just getting started",
	...
	},
	{
		...
		description:
			"Using @faire_auth with custom components feels like having someone hand you the remote while you're comfortably on the sofa. The ease I'm feeling rn is insane Auth done in under 5 minutes 🤌⚡.",
	...
	},
	{
		...
		description:
			"if you're building a code project in 2025 use @faire_auth. It has everything you need now and everything you'll need at scale. dont take this suggestion lightly..",
	...
	},
	{
		...
		description:
			"i cant believe how easy @faire_auth is compared to @authjs all i had to do was connect it to my drizzle schema and create a sign up page w the auth :)))",
...

	{
		...
		description: "faire-auth is a work of art.",
	...
	},
	{
		...
		description: "faire-auth is great, I use it everywhere",
