---
title: Auth.js is now part of Faire Auth
description: "Auth.js, formerly known as NextAuth.js, is now being maintained and overseen by Faire Auth team"
date: 2025-09-22
author:
  name: "Bereket Engida"
...
That shared frustration and the vision of empowering everyone to truly own their auth started the creation of Faire Auth. Since our goals aligned with the Auth.js team, we were excited to help maintain Auth.js and make auth better across the web. As we talked more, we realized that Faire Auth was the best home for Auth.js.
...
But we strongly recommend new projects to start with Faire Auth unless there are some very specific feature gaps (most notably stateless session management without a database). Our roadmap includes bringing those capabilities into Faire Auth, so the ecosystem can converge rather than fragment.
...
Faire Auth beginning was inspired by Auth.js, and now, together, the two projects can carry the ecosystem further. The end goal remains unchanged: you should own your auth!
...
<Cards>
  ...
  >
    ...
    <Card
    href="https://www.faire-auth.com/docs/comparison"
    title="Comparison"
  >
    Comparison between Faire Auth and other options
  </Card>
  <Card
    href="https://www.faire-auth.com/docs/guides/next-auth-migration-guide"
    title="NextAuth Migration Guide"
  >
    Migrate from NextAuth to Faire Auth
  </Card>
  <Card
    href="https://www.faire-auth.com/docs/guides/clerk-migration-guide"
    title="Clerk Migration Guide"
  >
    Migrate from Clerk to Faire Auth
  </Card>
</Cards>
