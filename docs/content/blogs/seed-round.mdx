...
We’re excited to share that Faire Auth has raised a $5 million seed round led by Peak XV Partners (formerly Sequoia Capital India & SEA), with participation from Y Combinator, Chapter One, P1 Ventures, and a group of incredible investors and angels.

This funding fuels the next phase of **Faire Auth**.
...
[Join the waitlist](https://faire-auth.build) to get early access to the infrastructure.

And if you're excited about making auth accessible - we're hiring!

Reach out to [careers@faire-auth.com](mailto:careers@faire-auth.com).
