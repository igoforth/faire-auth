---
title: Dub
description: Faire Auth Plugin for Lead Tracking using Dub links and OAuth Linking
---
...
<Steps>
    ...
    <Step>
        ...
        import { dubAnalytics } from "@dub/faire-auth"
        import { dub } from "dub"
...
import { dubAnalyticsClient } from "@dub/faire-auth/client";
