...
<Steps>
    <Step>
        ...
        **Options**
        ...
        import { passkey } from "faire-auth/plugins/passkey" // [!code highlight]
    ...
    <Step>
        ...
        import { passkeyClient } from "faire-auth/client/plugins"
...
await authClient.signIn.passkey.$post(
    { json: { autoFill: true } },
    {
        fetchOptions: {
            onSuccess(context) {
    ...
    <Step>
        ...
        <Tabs items={["React"]}>
            ...
            useEffect(() => {
              ...
              void authClient.signIn.passkey.$post({ json: { autoFill: true } })
            }, [])
            ```
            </Tab>
        </Tabs>
