---
title: Anonymous
description: Anonymous plugin for Faire Auth.
---
...
<Steps>
  <Step>
    ...
    import { anonymous } from "faire-auth/plugins" // [!code highlight]
  ...
  <Step>
    ...
    import { anonymousClient } from "faire-auth/client/plugins"
