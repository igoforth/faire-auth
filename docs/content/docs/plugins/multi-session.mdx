---
title: Multi Session
description: Learn how to use multi-session plugin in Faire Auth.
---
...
import { multiSession } from "faire-auth/plugins"
...
<Step>
        ...
        import { multiSessionClient } from "faire-auth/client/plugins"
