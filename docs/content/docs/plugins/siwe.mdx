...
description: Sign in with Ethereum plugin for Faire Auth
---
...
<Steps>
    ...
    <Step>
        ...
        import { siweClient } from "faire-auth/client/plugins";
...
import { faireAuth } from "faire-auth";
import { siwe } from "faire-auth/plugins";
import { generateRandomString } from "faire-auth/crypto";
