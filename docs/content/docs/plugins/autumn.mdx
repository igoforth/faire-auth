...
description: Faire Auth Plugin for Autumn Billing
---
...
<Steps>
  ...
  <Step>
    ...
    ```ts title="auth.ts"
    import { autumn } from "autumn-js/faire-auth";
  ...
  <Step>
      ...
      Client side, wrap your application with the AutumnProvider component, and pass in the `baseUrl` that you define within faire-auth's `authClient`.
      ...
      export default function RootLayout({
        ...
        return (
          <html>
            <body>
              {/* or meta.env.FAIRE_AUTH_URL for vite */}
              <AutumnProvider faireAuthUrl={process.env.NEXT_PUBLIC_FAIRE_AUTH_URL}>
                {children}
              </AutumnProvider>
            </body>
          </html>
