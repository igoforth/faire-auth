---
title: OAuth Proxy
description: OAuth Proxy plugin for Faire Auth
---
...
**productionURL**: If this value matches the `baseURL` in your auth config, requests will not be proxied. Defaults to the `FAIRE_AUTH_URL` environment variable.
