---
title: OIDC Provider
description: Open ID Connect plugin for Faire Auth that allows you to have your own OIDC provider.
---
...
<Callout type="warn">
This plugin is in active development and may not be suitable for production use. Please report any issues or bugs on [GitHub](https://github.com/igoforth/faire-auth).
</Callout>
...
<Steps>
    <Step>
        ...
        import { oidcProvider } from "faire-auth/plugins";
    ...
    <Step>
        ...
        import { oidcClient } from "faire-auth/client/plugins"
...
import { faireAuth } from "faire-auth";
import { oidcProvider } from "faire-auth/plugins";
import { jwt } from "faire-auth/plugins";
