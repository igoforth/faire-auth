---
title: MCP
description: MCP provider plugin for Faire Auth
---
...
import { oAuthProtectedResourceMetadata } from "faire-auth/plugins";
import { auth } from "@/lib/auth";
...
import { withMcpAuth } from "faire-auth/plugins";
import { z } from "zod";
