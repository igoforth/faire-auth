---
title: Dodo Payments
description: Faire Auth Plugin for Dodo Payments
---
...
```bash
npm install @dodopayments/faire-auth dodopayments faire-auth zod
```
...
```typescript
import { dodopaymentsClient } from "@dodopayments/faire-auth";

export const authClient = createAuthClient({
  baseURL: process.env.FAIRE_AUTH_URL || "http://localhost:3000",
