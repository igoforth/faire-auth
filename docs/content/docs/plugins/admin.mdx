---
title: Admin
description: Admin plugin for Faire Auth
---
...
<Steps>
  <Step>
    ...
    import { admin } from "faire-auth/plugins" // [!code highlight]
  ...
  <Step>
    ...
    import { adminClient } from "faire-auth/client/plugins"
...
<Steps>
   ...
   export const admin = ac.newRole({ // [!code highlight]
    ...
    ```ts title="permissions.ts"
    import { createAccessControl } from "faire-auth/plugins/access";
    import { defaultStatements, adminAc } from "faire-auth/plugins/admin/access";
    ...
    <Step>
        ...
        ```ts title="auth.ts"
        import { faireAuth } from "faire-auth"
        import { admin as adminPlugin } from "faire-auth/plugins"
