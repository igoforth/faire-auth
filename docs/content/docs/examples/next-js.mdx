...
description: Faire Auth Next.js example.
---

This is an example of how to use Faire Auth with Next.
...
See [Demo](https://demo.faire-auth.com)

<ForkButton url="igoforth/faire-auth/tree/main/demo/nextjs"  />

<iframe src="https://stackblitz.com/github/igoforth/faire-auth/tree/main/demo/nextjs?codemirror=1&fontsize=14&hidenavigation=1&runonclick=1&hidedevtools=1"
   style={{
      width: "100%",
      height: "500px",
      border: 0,
   ...
   title="Faire Auth Next.js Example"
