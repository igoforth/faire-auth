...
description: Integrate Faire Auth with Remix.
---

Faire Auth can be easily integrated with Remix. This guide will show you how to integrate Faire Auth with Remix.
...
And in this file, import Faire Auth and create your instance.
...
<Callout type="info">
 You can change the path on your faire-auth configuration but it's recommended to keep it as `routes/api.auth.$.ts`
</Callout>
