...
description: Integrate Faire Auth with Next.js.
---

Faire Auth can be easily integrated with Next.js. Before you start, make sure you have a Faire Auth instance configured. If you haven't done that yet, check out the [installation](/docs/installation).
...
<Callout type="info">
 You can change the path on your faire-auth configuration but it's recommended to keep it as `/api/auth/[...all]`
</Callout>
...
import { nextCookies } from "faire-auth/next-js";
...
Faire Auth is fully compatible with Next.js 16. You can refer to the [Next.js 16 beta](https://nextjs.org/blog/next-16-beta) for more details on the new features and changes.

Here are some important changes to note when using Faire Auth with Next.js 16:
...
All Faire Auth functionality remains the same.
</Callout>
