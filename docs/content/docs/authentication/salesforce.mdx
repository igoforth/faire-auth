...
<Steps>
    ...
    <Callout type="info">
        ...
        - The callback URL must exactly match what's configured in Faire Auth
  ...
  ### Configure the provider
   ...
   <Step>
    ...
    FAIRE_AUTH_URL=http://localhost:3000 # Important for redirect URI generation
    ```
    ...
    SALESFORCE_CLIENT_ID=your_consumer_key_here
    SALESFORCE_CLIENT_SECRET=your_consumer_secret_here
    FAIRE_AUTH_URL=https://yourdomain.com
    ```
    </Step>
...
<Step>
    ...
    1. **Check Callback URL**: Ensure the Callback URL in your Salesforce Connected App exactly matches your Faire Auth callback URL
