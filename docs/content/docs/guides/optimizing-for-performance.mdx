...
description: A guide to optimizing your Faire Auth application for performance.
---

In this guide, we’ll go over some of the ways you can optimize your application for a more performant Faire Auth app.

## Caching

Caching is a powerful technique that can significantly improve the performance of your Faire Auth application by reducing the number of database queries and speeding up response times.
...
Optimizing database performance is essential to get the best out of Faire Auth.
