...
```ts title="client.ts"
import { FaireAuthClientPlugin } from "faire-auth";
...
our <Link href="https://discord.gg/faire-auth">Discord server</Link>,
or through a <Link href="https://github.com/igoforth/faire-auth/pulls">pull-request</Link>
