...
description: A step-by-step guide to creating a browser extension with Faire Auth.
---

In this guide, we'll walk you through the steps of creating a browser extension using <Link href="https://docs.plasmo.com/">Plasmo</Link> with Faire Auth for authentication.

If you would like to view a completed example, you can check out the <Link href="https://github.com/faire-auth/examples/tree/main/browser-extension-example">browser extension example</Link>.

<Callout type="warn">
  The Plasmo framework does not provide a backend for the browser extension.
  This guide assumes you have{" "}
  <Link href="/docs/integrations/hono">a backend setup</Link> of Faire Auth and
...
<Steps>
    ...
    <Step>
        ...
        Then, install the Faire Auth package.
    ...
    <Step>
       ...
       <Files>
        ...
        export const authClient = createAuthClient({
            baseURL: "http://localhost:3000" /* Base URL of your Faire Auth backend. */,
            plugins: [],
        });
        ```
    </Step>
    ...
    <Step>
        ...
        We must ensure the extension knows the URL to the Faire Auth backend.
    ...
    <Step>
        ...
        You have now set up Faire Auth for your browser extension.

        Add your desired UI and create your dream extension!

        To learn more about the client Faire Auth API, check out the <Link href="/docs/concepts/client">client documentation</Link>.
...
Congratulations! You've successfully created a browser extension using Faire Auth and Plasmo.
...
If you have any questions, feel free to open an issue on our <Link href="https://github.com/igoforth/faire-auth/issues">GitHub repo</Link>, or join our <Link href="https://discord.gg/faire-auth">Discord server</Link> for support.
