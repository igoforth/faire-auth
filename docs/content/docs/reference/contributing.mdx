---
title: Contributing to FaireAuth
description: A concise guide to contributing to FaireAuth
---

Thank you for your interest in contributing to Faire Auth! This guide is a concise guide to contributing to Faire Auth.

## Getting Started

Before diving in, here are a few important resources:

- Take a look at our existing <Link href="https://github.com/igoforth/faire-auth/issues">issues</Link> and <Link href="https://github.com/igoforth/faire-auth/pulls">pull requests</Link>
- Join our community discussions in <Link href="https://discord.gg/faire-auth">Discord</Link>
...
<Steps>
    ...
    <Step>
        ...
        Visit https://github.com/igoforth/faire-auth
...
- Check our [GitHub issues](https://github.com/igoforth/faire-auth/issues) for tasks labeled `good first issue`
...
describe("Feature", (test) => {
    test("should work as expected", async ({ expect }) => {
...
- Open an <Link href="https://github.com/igoforth/faire-auth/issues">issue</Link> with questions
- Join our <Link href="https://discord.gg/faire-auth">community discussions</Link>
- Reach out to project maintainers

Thank you for contributing to Faire Auth!
