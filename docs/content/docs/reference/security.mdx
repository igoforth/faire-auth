...
If you discover a security vulnerability in Faire Auth, please report it to us at [security@faire-auth.com](mailto:security@faire-auth.com). We address all reports promptly, and credits will be given for validated discoveries.
